    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                reason,
                status: "pending",
                created_at: toPKTISO(getCurrentTime()),
                            ...
                            <>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="grid gap-2">
                                        ...
                                        />
                                        <div className="text-[10px] text-slate-400">Current: {entry?.clock_in ? format(parsePKT(entry.clock_in), "HH:mm") : "N/A"}</div>
                                    </div>
                                    <div className="grid gap-2">
                                        ...
                                        />
                                        <div className="text-[10px] text-slate-400">Current: {entry?.clock_out ? format(parsePKT(entry.clock_out), "HH:mm") : "N/A"}</div>
                                    </div>
                                </div>
