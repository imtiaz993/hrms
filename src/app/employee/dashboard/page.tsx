...
import { useGetAttendanceAnalytics, useGetAvailableMonths } from '@/hooks/useAttendanceAnalytics';
...
import { User, Lock, Clock, Calendar, DollarSign, TrendingUp, FileText, Plus, X, LogOut } from 'lucide-react';
...
export default function EmployeeDashboardPage() {
  ...
  const { data: birthdays } = useGetUpcomingBirthdays(1);
  const { data: anniversaries } = useGetUpcomingAnniversaries(1);
